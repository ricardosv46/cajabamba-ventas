...
export type GetDetalleAsientoVentaQuery = { __typename?: 'Query', GetDetalleAsientoVenta?: { __typename?: 'AsignacionEntrada', asientoId?: string | null, nombres?: string | null, tipoDocumento?: string | null, numDocumento?: string | null, apellidos?: string | null, reservado?: string | null, tendido?: string | null, codigo?: string | null, fecha?: any | null, hora?: string | null } | null };
...
export type ReporteAsientoVendedoraQueryVariables = Exact<{
  code?: InputMaybe<Scalars['String']>;
}>;


export type ReporteAsientoVendedoraQuery = { __typename?: 'Query', ReporteAsientoVendedora?: string | null };
 ...
 * });
 */
export function useGetDetalleAsientoVentaQuery(baseOptions?: Apollo.QueryHookOptions<GetDetalleAsientoVentaQuery, GetDetalleAsientoVentaQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetDetalleAsientoVentaQuery, GetDetalleAsientoVentaQueryVariables>(GetDetalleAsientoVentaDocument, options);
      }
export function useGetDetalleAsientoVentaLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetDetalleAsientoVentaQuery, GetDetalleAsientoVentaQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetDetalleAsientoVentaQuery, GetDetalleAsientoVentaQueryVariables>(GetDetalleAsientoVentaDocument, options);
        }
export type GetDetalleAsientoVentaQueryHookResult = ReturnType<typeof useGetDetalleAsientoVentaQuery>;
export type GetDetalleAsientoVentaLazyQueryHookResult = ReturnType<typeof useGetDetalleAsientoVentaLazyQuery>;
export type GetDetalleAsientoVentaQueryResult = Apollo.QueryResult<GetDetalleAsientoVentaQuery, GetDetalleAsientoVentaQueryVariables>;
...
export const ReporteAsientoVendedoraDocument = gql`
...
/**
 * __useReporteAsientoVendedoraQuery__
 *
 * To run a query within a React component, call `useReporteAsientoVendedoraQuery` and pass it any options that fit your needs.
 * When your component renders, `useReporteAsientoVendedoraQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useReporteAsientoVendedoraQuery({
 *   variables: {
 *      code: // value for 'code'
 *   },
 * });
 */
export function useReporteAsientoVendedoraQuery(baseOptions?: Apollo.QueryHookOptions<ReporteAsientoVendedoraQuery, ReporteAsientoVendedoraQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<ReporteAsientoVendedoraQuery, ReporteAsientoVendedoraQueryVariables>(ReporteAsientoVendedoraDocument, options);
      }
export function useReporteAsientoVendedoraLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<ReporteAsientoVendedoraQuery, ReporteAsientoVendedoraQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<ReporteAsientoVendedoraQuery, ReporteAsientoVendedoraQueryVariables>(ReporteAsientoVendedoraDocument, options);
        }
export type ReporteAsientoVendedoraQueryHookResult = ReturnType<typeof useReporteAsientoVendedoraQuery>;
export type ReporteAsientoVendedoraLazyQueryHookResult = ReturnType<typeof useReporteAsientoVendedoraLazyQuery>;
export type ReporteAsientoVendedoraQueryResult = Apollo.QueryResult<ReporteAsientoVendedoraQuery, ReporteAsientoVendedoraQueryVariables>;